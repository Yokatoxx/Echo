...
Shader "ASE/Interior Mapping/LatLong"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 worldToTangentDir182_g135 = mul( ase_worldToTangent, reflect( ase_viewDirSafeWS , ase_normalWSNorm ));
			...
			float4 lerpResult195 = lerp( float4( lerpResult408 , 0.0 ) , tex2D( _Roof, uv_Roof ) , ase_normalWS.y);
			...
			float3 lerpResult203 = lerp( lerpResult411 , float3( 0,0,0 ) , ase_normalWS.y);
			o.Emission = lerpResult203;
			float FacadeAlpha175 = tex2DNode178.a;
			float lerpResult412 = lerp( 0.0 , FacadeAlpha175 , _EnableFacade);
			float lerpResult204 = lerp( lerpResult412 , 0.0 , ase_normalWS.y);
...
ASEEND*/
//CHKSM=B0F1E839DF164273701D23175E0F4C4D4560644A
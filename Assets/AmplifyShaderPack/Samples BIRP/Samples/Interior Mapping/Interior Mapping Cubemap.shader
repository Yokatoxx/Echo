...
Shader "ASE/Interior Mapping/Cubemap"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult405 = lerp( float4( lerpResult399 , 0.0 ) , tex2D( _Roof, uv_Roof ) , ase_normalWS.y);
			...
			float lerpResult403 = lerp( lerpResult397 , 0.0 , ase_normalWS.y);
...
ASEEND*/
//CHKSM=183C4458F9B51B08C7E9719388F3F1D00533122C
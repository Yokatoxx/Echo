...
Shader "AmplifyShaderPack/Terrain/Simple"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_output_707_0_g13 = ( localCalculateTangentsStandard706_g13 + ase_normalOS );
			v.normal = temp_output_707_0_g13;
			float4 appendResult704_g13 = (float4(cross( ase_normalOS , float3(0,0,1) ) , -1.0));
...
ASEEND*/
//CHKSM=1682BA98A89015C4CEAAF09D774DD80976A7729D